 ...
 * @author HP
 */
public class OpportunityAffichageEntreprise extends SideMenuBaseForm {
      Form f;
      int Number ;
    TextField JobTitle;
    ...
    SpanLabel lb;
    public OpportunityAffichageEntreprise(Resources res) {
        super(BoxLayout.y());
        ...
        Container completedTasks = BoxLayout.encloseY(
                        new Label("", "CenterTitle"),
                        new Label("Welcome", "CenterSubTitle")
        );
       ...
       btnajout.addActionListener((x) -> {
           if (JobTitle.getText().isEmpty() || JobCategory.getText().isEmpty() || JobDescription.getText().isEmpty() || JobDuration.getText().isEmpty())
           {
                ToastBar.showMessage("Please fill all the fields", FontImage.MATERIAL_CHECK);
           }
           else {
        ...
        add(new Label("All your Opportunities", "TodayTitle"));
        ...
        for (Opportunity i : cs.getList2())
    {
            ...
            public void actionPerformed(ActionEvent evt) {
                 ...
                 detailOpportunityEntreprise b=new detailOpportunityEntreprise(res,i.getId_Opp());
                b.show();
...
//        addButtonBottom(arrowDown, "Surprise Party for Matt", 0xffc06f, false);
    ...
    private Image createCircleLine(int color, int height, boolean first) {
     ...
     public OpportunityAffichageEntreprise() {
